...
limited by velocity, acceleration, and jerk constraints.";
    ...
    nb::class_<InputParameter<DynamicDOFs>>(m, "InputParameter")
        ...
        .def_rw("min_velocity", &InputParameter<DynamicDOFs>::min_velocity)
        .def_rw("min_acceleration", &InputParameter<DynamicDOFs>::min_acceleration)
        .def_rw("intermediate_positions", &InputParameter<DynamicDOFs>::intermediate_positions)
        .def_rw("per_section_max_velocity", &InputParameter<DynamicDOFs>::per_section_max_velocity)
        .def_rw("per_section_max_acceleration", &InputParameter<DynamicDOFs>::per_section_max_acceleration)
        .def_rw("per_section_max_jerk", &InputParameter<DynamicDOFs>::per_section_max_jerk)
        .def_rw("per_section_min_velocity", &InputParameter<DynamicDOFs>::per_section_min_velocity)
        .def_rw("per_section_min_acceleration", &InputParameter<DynamicDOFs>::per_section_min_acceleration)
        .def_rw("per_section_max_position", &InputParameter<DynamicDOFs>::per_section_max_position)
        .def_rw("per_section_min_position", &InputParameter<DynamicDOFs>::per_section_min_position)
        ...
        .def_rw("per_dof_control_interface", &InputParameter<DynamicDOFs>::per_dof_control_interface)
        .def_rw("per_dof_synchronization", &InputParameter<DynamicDOFs>::per_dof_synchronization)
        .def_rw("minimum_duration", &InputParameter<DynamicDOFs>::minimum_duration)
        .def_rw("per_section_minimum_duration", &InputParameter<DynamicDOFs>::per_section_minimum_duration)
        .def_rw("interrupt_calculation_duration", &InputParameter<DynamicDOFs>::interrupt_calculation_duration)
